...
export default function HomePage() {
  ...
  const roadmap = [
    {
      phase: "Fundamentals",
      items: ["Anthropic API basics", "Prompt patterns", "JavaScript ES6+"],
    },
    {
      phase: "Integration",
      items: ["Stream handling", "Error management", "API best practices"],
    },
    {
      phase: "Advanced",
      items: ["Multi-turn conversations", "Tool use", "Production deployments"],
    },
  ];
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-4">
        ...
        <p className="text-xl text-gray-600 max-w-2xl">
          A practical journey through prompt engineering, JavaScript, and
          APIs—building intelligent applications with Claude.
        </p>
      </section>
      ...
      <section className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-lg p-8 text-center space-y-4">
        ...
        <p className="text-gray-600">
          Explore the chat interface to test Claude&apos;s capabilities, or head
          to the operations page to dive deeper into your learning.
        </p>
